...
function CreateCompt() {
  ...
  return (
    <div  style={{ backgroundImage: `url(${fond})` }} className="w-full bg-cover h-[100vh] bg-cover bg-center flex flex-col  items-center justify-center mx-auto gap-y-20  ">
      <h2 className="text-[#7E1037] font-bold text-center text-5xl ">S'inscrire</h2>
      <form onSubmit={handleSubmit} className='flex flex-col space-y-5 justify-center items-center' >
        <div className='flex  gap-x-10'>
            <div className="mb-4">
              <label htmlFor="name" className="block text-sm font-medium text-[#7E1037]">Nom</label>
              <input
                type="text"
                id="name"
                name="name"
        ...
        <div className='flex space-x-10'>
          ...
          <div className="mb-4">
            <label htmlFor="password" className="block text-sm font-medium text-[#7E1037]">Confirmation de mot de passe</label>
            <input
              type="password"
              id="password"
              name="password"
        ...
        <button
          type="submit"
          className="cursor-pointer w-1/4 py-3 text-white font-semibold rounded-4xl h-14 bg-gradient-to-r from-[#7E1037] to-[#E41D64] hover:bg-gradient-to-l"
        >
          S'inscrire
        </button>
        <div className='flex space-x-2 text-[#7E1037]'>
            <p className=''>Vous avez déjà un compte? </p>
            <a href='' className='font-bold hover:text-[#E41D64]'>Connexion</a> 
        </div>
