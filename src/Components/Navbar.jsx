...
export default function Navbar({ onIconClick, sectionActive }) {
  ...
  className='absolute z-5 h-screen'>
      ...
      <motion.div 
       ...
       className=' h-screen bg-[#7E1037] w-64 py-5 px-5 flex flex-col justify-between shadow-sm shadow-black rounded-r-xl'>
        <div className='flex flex-col space-y-10 '>
          ...
          <div onClick={() => onIconClick('profil')} className='p-2 cursor-pointer  flex items-center text-xl space-x-4  cursor-pointer rounded-sm '>
          ...
          <div  onClick={() => onIconClick('liste')} className='p-2 cursor-pointer  flex items-center text-xl space-x-4  cursor-pointer rounded-sm '>
          ...
          <div onClick={() => onIconClick('search')} className='p-2 cursor-pointer  flex items-center text-xl space-x-4 cursor-pointer rounded-sm '>
          ...
          <div onClick={() => onIconClick('setting')} className='p-2  cursor-pointer  flex items-center text-xl space-x-4 cursor-pointer rounded-sm '>
   ...
   <div className=' h-screen bg-[#7E1037]  w-20 py-5 items-center flex flex-col justify-between shadow-sm shadow-black rounded-r-xl'>
       <div className='flex flex-col space-y-10 '>
         <div className='p-2 cursor-pointer rounded-sm '>
